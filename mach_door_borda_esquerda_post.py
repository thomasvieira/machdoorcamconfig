...
import mach_door_fechadura
mach_door_fechadura.export(object, "/path/to/file.ncc")
"""
...
SPINDLE_WAIT = 7  # no waiting after M3 / M4 by default
...
parser = argparse.ArgumentParser(prog="mach_door_topo", add_help=False)
                ...
                if param in c.Parameters:
                    if param == "F":
                        ...
                        if int(c.Parameters[param]) <= 10 :
                            ...
                            deslocamento = getDistPivotCone90Graus() + getToolLength(CURRENT_TOOL) + 1000
                        ...
                        c.Parameters[param] = c.Parameters[param] + getDistPivotCone90Graus() + getToolLength(CURRENT_TOOL)
