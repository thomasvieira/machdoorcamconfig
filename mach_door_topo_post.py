...
TOOLTIP = """
Gera g-code para usinagem da borda do pivot de topo.
import mach_door_topo
mach_door_topo.export(object, "/path/to/file.ncc")
"""
...
def export(objectslist, filename, argstring):
    ...
    if OUTPUT_HEADER:
        ...
        gcode += linenumber() + "(Pós Processador: Mach Door Topo)\n"
            ...
            for param in params:
                if param in c.Parameters:
                    if param == "F":
                        ...
                        outstring.append(
                            "Y" + format(float(pos.getValueAs(UNIT_FORMAT)), precision_string)
                        )
                    elif param in ["J"]:
                        pos = Units.Quantity(c.Parameters[param], FreeCAD.Units.Length)
                        #pos = pos * -1
                        ...
                        outstring.append(
                            "J" + format(float(pos.getValueAs(UNIT_FORMAT)), precision_string)
                        )
