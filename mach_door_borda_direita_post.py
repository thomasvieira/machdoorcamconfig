...
TOOLTIP = """
Gera g-code para usinagem da borda do lado da fechadura.
import mach_door_borda_direita
mach_door_borda_direita.export(object, "/path/to/file.ncc")
"""
...
parser = argparse.ArgumentParser(prog="mach_door_borda_direita", add_help=False)
...
def export(objectslist, filename, argstring):
    ...
    if OUTPUT_HEADER:
        ...
        gcode += linenumber() + "(Pós Processador: Mach Door Borda Direita)\n"
                ...
                if param in c.Parameters:
                    if param == "F":
                        ...
                        if int(c.Parameters[param]) <= 10 :
                            ...
                            outstring.append("\nG00 C" + str(getPosCFechadura()))
                            deslocamento = getDistPivotCone90Graus() + getToolLength(CURRENT_TOOL)
                        ...
                        correctedDistPivotCone = correctedDistPivotCone - 0.3
                        ...
                        c.Parameters[param] += getDistPivotCone90Graus() + getToolLength(CURRENT_TOOL)
