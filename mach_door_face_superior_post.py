...
TOOLTIP = """
Gera g-code para usinagem compativel com a face da porta.
import mach_door_face_superior
mach_door_face_superior.export(object, "/path/to/file.ncc")
"""
...
PREAMBLE = """G17 G90
(M702 - ABRE VALVULA DE VACUO E TRAVA PORTA)
M702
(M701 - DESCE O ESQUADRO)
M701
(M707 - SOBE O BOCAL)
M707
...
parser = argparse.ArgumentParser(prog="mach_door_face_superior", add_help=False)
...
def export(objectslist, filename, argstring):
    ...
    if OUTPUT_HEADER:
        ...
        gcode += linenumber() + "(Pós Processador: Mach Door Face Superior)\n"
            ...
            for param in params:
                if param in c.Parameters:
                    if param == "F":
                        ...
                        #print(str(getToolLength(CURRENT_TOOL)))
                        c.Parameters[param] += getToolLength(CURRENT_TOOL)
