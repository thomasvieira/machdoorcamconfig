...
TOOLTIP = """
Gera g-code para usinagem da borda do pivot de base.
import mach_door_base
mach_door_base.export(object, "/path/to/file.ncc")
"""
...
parser = argparse.ArgumentParser(prog="mach_door_base", add_help=False)
...
def export(objectslist, filename, argstring):
    ...
    if OUTPUT_HEADER:
        ...
        gcode += linenumber() + "(Pós Processador: Mach Door Base)\n"
        ...
        for c in PathUtils.getPathWithPlacement(pathobj).Commands:
            ...
            for param in params:
                if param in c.Parameters:
                    ...
                    else:  # [X, Y, Z, U, V, W, I, R, Q] (Conversion eventuelle mm/inches)
                        pos = Units.Quantity(c.Parameters[param], FreeCAD.Units.Length)
                        outstring.append(
